...
public final class Message extends Table {
  ...
  public byte typeOfMessageType() { int o = __offset(4); return o != 0 ? bb.get(o + bb_pos) : 0; }
  public Table typeOfMessage(Table obj) { int o = __offset(6); return o != 0 ? __union(obj, o + bb_pos) : null; }

  public static int createMessage(FlatBufferBuilder builder,
      byte typeOfMessageType,
      int typeOfMessageOffset) {
  ...
  public static void addTypeOfMessageType(FlatBufferBuilder builder, byte typeOfMessageType) { builder.addByte(0, typeOfMessageType, 0); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Message get(Message obj, int j) {  return obj.__assign(Table.__indirect(__element(j), bb), bb); }
  }
}
