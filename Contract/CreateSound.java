...
public final class CreateSound extends Table {
    public static void ValidateVersion() {
        Constants.FLATBUFFERS_23_5_26();
    }

    public static CreateSound getRootAsCreateSound(ByteBuffer _bb) {
        return getRootAsCreateSound(_bb, new CreateSound());
    }

    public static CreateSound getRootAsCreateSound(ByteBuffer _bb, CreateSound obj) {
    ...
    public CreateSound __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public ByteBuffer extensionAsByteBuffer() {
        return __vector_as_bytebuffer(6, 1);
    }

    public ByteBuffer extensionInByteBuffer(ByteBuffer _bb) {
    ...
    public ByteVector dataVector(ByteVector obj) {
        int o = __offset(8);
    ...
    // New property: isDefault
    public boolean isDefault() { int o = __offset(10);
        return o != 0 && 0 != bb.get(o + bb_pos); }

    public static int createCreateSound(FlatBufferBuilder builder,
                                        int nameOffset,
                                        int extensionOffset,
                                        int dataOffset,
                                        boolean isDefault) {
        ...
        CreateSound.addIsDefault(builder, isDefault);
        return CreateSound.endCreateSound(builder);
    }

    // New method: addIsDefault
    public static void addIsDefault(FlatBufferBuilder builder, boolean isDefault) {
        builder.addBoolean(3, isDefault, false);
    }

    public static void startCreateSound(FlatBufferBuilder builder) {
    ...
    public static void addExtension(FlatBufferBuilder builder, int extensionOffset) {
        builder.addOffset(1, extensionOffset, 0);
    }
    ...
    public static int endCreateSound(FlatBufferBuilder builder) {
    ...
    public static final class Vector extends BaseVector {
        ...
        public CreateSound get(int j) {
            return get(new CreateSound(), j);
        }

        public CreateSound get(CreateSound obj, int j) {
